...
class NightMode:
    ...
    def __init__(self, start_time: str = "22:00", end_time: str = "07:00", 
        ...
        try:
            ...
            logger.info("NightMode initialized: %s to %s, brightness=%.1f%%, grace=%d min",
    ...
    def apply_night_mode(self, rule: EventRuleConfig) -> EventRuleConfig:
        ...
        if night_rule.blink.mode == "custom":
            ...
            logger.debug("Night mode: reduced brightness from %d to %d (%.1f%%)",
                        original_brightness, night_rule.blink.custom.brightness,
    ...
    def update_settings(self, start_time: str = None, end_time: str = None,
